...
open class ExtendedQueryExectionListener : QueryExecutionListener, MethodExecutionListener {
  ...
  final override fun beforeQuery(execInfo: ExecutionInfo?, queryInfoList: MutableList<QueryInfo>?) {
  ...
  final override fun afterQuery(execInfo: ExecutionInfo?, queryInfoList: MutableList<QueryInfo>?) {
    if (queryInfoList == null) return;
...
class VitessScaleSafetyChecks(
  ...
  inner class CowriteDetector : ExtendedQueryExectionListener() {
    val keyspaceIdsThisTransaction: ThreadLocal<HashSet<String>> =
        ThreadLocal.withInitial { HashSet<String>() }
  ...
  val DML = hashSetOf("insert", "delete", "update")
  ...
  private fun connect(): Connection {
    ...
    connection = cluster.connectMySQL()
